...
List<Rotta> result= new ArrayList<>();
		...
		try {
			...
			while(rs.next()) {
				Airport partenza= idMap.get(rs.getInt("ORIGIN_AIRPORT_ID"));
				Airport arrivo= idMap.get(rs.getInt("DESTINATION_AIRPORT_ID"));
				if(partenza!= null && arrivo!=null) {
				Rotta r= new Rotta(partenza,arrivo,rs.getInt("tot"));
				result.add(r);
				}else {
