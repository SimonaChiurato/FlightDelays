...
public class FXMLController {
    ...
    void doAnalizzaAeroporti(ActionEvent event) {
    	...
    	this.txtResult.appendText("Grafo creato con vertici: "+this.model.numeroVertici()+" archi: "+this.model.numeroArchi());
    	
    	this.cmbBoxAeroportoPartenza.getItems().addAll(this.model.getAirport());
    	this.cmbBoxAeroportoDestinazione.getItems().addAll(this.model.getAirport());
    }
